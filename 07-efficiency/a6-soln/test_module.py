...
def test_lowest_temperature_4():
   # optional fourth test
   data = [["20081114", "Chicago", "50.1", "30.0", "35.7"],
           ["20081115", "Detroit", "45.2", "30.3", "33.4"]]
   assert module.lowest_temperature(data, "20081115") == "Detroit"
...
def test_copilot_4():
   ...
   data = [["20081114", "Chicago", "50.1", "30.0", "35.7"],
           ["20081115", "Detroit", "45.2", "30.3", "33.4"]]
   assert module.lowest_temperature_alt_1(data, "20081115") == "Detroit"
   assert module.lowest_temperature_alt_2(data, "20081115") == "Detroit"
   assert module.lowest_temperature_alt_3(data, "20081115") == "Detroit"